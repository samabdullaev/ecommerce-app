    ...
    <section className="container mb-50 d-none d-md-block">
      <div className="row about-count">
        ...
        <div className="col-lg-1-5 col-md-6 text-center">
          <h1 className="heading-1">
            <span className="count">
              <CountUp isCounting end={36} duration={3.2} />
            </span>+</h1>
          <h4>Happy clients</h4>
        </div>
        <div className="col-lg-1-5 col-md-6 text-center">
          <h1 className="heading-1">
            <span className="count">
              <CountUp isCounting end={58} duration={3.2} />
            </span>+</h1>
        ...
        <div className="col-lg-1-5 col-md-6 text-center">
          <h1 className="heading-1">
            <span className="count">
              <CountUp isCounting end={24} duration={3.2} />
            </span>+</h1>
          <h4>Team advisor</h4>
        </div>
        <div className="col-lg-1-5 text-center d-none d-lg-block">
          <h1 className="heading-1">
            <span className="count">
              <CountUp isCounting end={26} duration={3.2} />
            </span>+</h1>
          <h4>Products Sale</h4>
        </div>
      </div>
